...
class Detector:
    ...
    def __creating_main_chain(self):
        self.analyzing_thief_detection_chain = (lambda input: {'pydantic_instruction':self.thief_parser_instructions, 'sequence_images':retrieve_sequence_past_images(self.resolution)}) | self.thief_detection_chain
